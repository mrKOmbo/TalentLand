...
/// Source: bitchat (public domain) — https://github.com/permissionlesstech/bitchat
enum Geohash {
    ...
    static func neighbors(of geohash: String) -> [String] {
        ...
        let neighborCoords: [(lat: Double, lon: Double)] = [
        ...
        return neighborCoords.compactMap { neighbor in
